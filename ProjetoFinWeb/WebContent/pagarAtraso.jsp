...
ListLancamento atraso = new ListLancamento(idUsuario, 2, Biblioteca.Today());
...
<div class="conteudoSubTab">
	<div class="divgeral3">
	    <display:table name="atraso" defaultsort="1" defaultorder="ascending" decorator="org.displaytag.decorator.TotalTableDecorator">
		    ...
		    <display:column property="observacao" title="Histórico" headerClass="sortable"/>
