...
request.setAttribute( "grafDSGrupoReceitas", new DadosGraficoPizzaSetorialDataSet("GrupoReceitas",idUsuario));
%>
<div class="conteudoSubTab">
	<div class="divgeral4">			
		<!-- GRÁFICO SETORIAL/PIZZA EM 3D -->		
		<cewolf:chart id="grafico2" title="Grupos de Receitas" type="pie3d">
		    <cewolf:gradientpaint>
		        <cewolf:point x="0" y="0" color="#FBFBFB" />
		        <cewolf:point x="350" y="0" color="#F3F3F3" />
		    </cewolf:gradientpaint>
		    <cewolf:data>
		        <cewolf:producer id="grafDSGrupoReceitas" />
			</cewolf:data>
		</cewolf:chart>
