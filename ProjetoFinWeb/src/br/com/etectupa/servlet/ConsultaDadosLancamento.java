...
public class ConsultaDadosLancamento extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ConsultaDadosLancamento() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		request.getRequestDispatcher("dadosLancamento.jsp").forward(request, response);
